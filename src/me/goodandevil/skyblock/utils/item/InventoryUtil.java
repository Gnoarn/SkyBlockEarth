...
public class InventoryUtil {
	...
	public InventoryUtil(String inventoryTitle, InventoryType inventoryType, int inventoryRows) {
		if (inventoryType == null) {
			inventory = Bukkit.getServer().createInventory(null, inventoryRows * 9, ChatColor.translateAlternateColorCodes('&', inventoryTitle));
		} else {
			inventory = Bukkit.getServer().createInventory(null, inventoryType, ChatColor.translateAlternateColorCodes('&', inventoryTitle));
		}
	}
