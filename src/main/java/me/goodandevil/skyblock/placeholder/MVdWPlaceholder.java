...
public class MVdWPlaceholder {
	...
	public void register() {
		...
		PlaceholderAPI.registerPlaceholder(skyblock, "skyblockearth_islands", new PlaceholderReplacer() {
			@Override
		...
		for (int i = 0; i < 10; i++) {
			PlaceholderAPI.registerPlaceholder(skyblock, "skyblockearth_leaderboard_votes_" + (i + 1),
					new PlaceholderReplacer() {
						@Override
						public String onPlaceholderReplace(PlaceholderReplaceEvent event) {
							int index = Integer
									.valueOf(event.getPlaceholder().replace("skyblockearth_leaderboard_votes_", ""));
							...
							if (index < leaderboardVotesPlayers.size()) {
								...
								return ChatColor.translateAlternateColorCodes('&',
										configLoad.getString("Placeholder.skyblockearth_leaderboard_votes.Non-empty.Message")
							...
							return ChatColor.translateAlternateColorCodes('&',
									configLoad.getString("Placeholder.skyblockearth_leaderboard_votes.Empty.Message"));
						}
					});

			PlaceholderAPI.registerPlaceholder(skyblock, "skyblockearth_leaderboard_level_" + (i + 1),
					new PlaceholderReplacer() {
						@Override
						public String onPlaceholderReplace(PlaceholderReplaceEvent event) {
							int index = Integer
									.valueOf(event.getPlaceholder().replace("skyblockearth_leaderboard_level_", ""));
							...
							if (index < leaderboardLevelPlayers.size()) {
								...
								return ChatColor.translateAlternateColorCodes('&', configLoad
										.getString("Placeholder.skyblockearth_leaderboard_level.Non-empty.Message")
							...
							return ChatColor.translateAlternateColorCodes('&',
									configLoad.getString("Placeholder.skyblockearth_leaderboard_level.Empty.Message"));
						}
					});
		}
