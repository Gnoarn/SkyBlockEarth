...
public class FileManager {
	...
	public void loadConfigs() {
		...
		if (NMSManager.getInstance().getVersionNumber() < 13) {
			configFiles.put("levelling-oldmaterials.yml", new File(instance.getDataFolder(), "levelling.yml"));
		} else {
			configFiles.put("levelling-newmaterials.yml", new File(instance.getDataFolder(), "levelling.yml"));
		}
