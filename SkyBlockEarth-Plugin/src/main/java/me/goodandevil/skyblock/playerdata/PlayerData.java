...
public class PlayerData {
	...
	private Config getConfig() {
		return SkyBlockEarth.getInstance().getFileManager().getConfig(new File(new File(SkyBlockEarth.getInstance().getDataFolder().toString() + "/player-data"), uuid.toString() + ".yml"));
	}
}
