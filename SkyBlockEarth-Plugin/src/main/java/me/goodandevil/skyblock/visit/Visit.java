...
public class Visit {
	...
	protected Visit(SkyBlockEarth plugin, UUID islandOwnerUUID, Location[] islandLocations, int islandMembers, int islandLevel, List<String> islandSignature, boolean open) {
		this.plugin = plugin;
